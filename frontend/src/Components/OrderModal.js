...
const OrderModal = ({ order, closeModal }) => {
  ...
  //for all inputs
    ...
    return(
        ...
        <input value={editOrder.company_name}
        ...
        name="company_name"
            ...
            <label>Contact Name: </label>
                <input value={editOrder.contact_name}
                onChange={handleChange}
                name="contact_name"
            ...
            <label>Steet Address</label>
                <input value={editOrder.street_address}
                onChange={handleChange}
                name="street_address"
            ...
            <select onChange={handleChange} value={editOrder.delivery_status}
