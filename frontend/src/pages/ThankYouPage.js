        ...
        <main className="thank-div">
            ...
            <div className="thank-content">
                ...
                <p className="thank-message">
                    Your request has been successfully submitted and our team
                    is now reviewing your shipment details.
                </p>
                ...
                <div className="thank-next">
                    ...
                    <div className="thank-step">
                        ...
                        <div>
                            ...
                            <p>
                                We've sent a confirmation to the email address
                                you provided.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="thank-step">
                        ...
                        <div>
                            ...
                            <p>
                                Your quotation PDF will be included with the
                                confirmation email.
                            </p>
                        </div>
                    </div>
