                ...
                <div className="shipper-section">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={
                        emptyFields.includes("company_name") ? "error" : ""
                      }
                    />
                  </div>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("contact_name") ? "error" : ""
                      }
                    />
                  </div>
                ...
                <div className="recipient-section">
                  ...
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("recipient_name") ? "error" : ""
                      }
                    />
                  </div>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("recipient_email") ? "error" : ""
                      }
                    />
                  </div>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("recipient_phone") ? "error" : ""
                      }
                    />
                  </div>
                </div>
