    ...
    <>
      <div className="form-page">
        <div className="form-card">
          <button className="back-btn" onClick={handleBacktBtn}>
            {" "}
            Back
          </button>
          <form>
            <div className="form-header">
              <div className="form-progress">
                ...
                <div className="package-image">
                  <img src={Dimensions} alt="Package Dimensions" />
                </div>
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("service_type") ? "error" : ""
                    }
                  >
                ...
                {formData.service_type === "air" && (
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("origin_airport") ? "error" : ""
                      }
                    >
                ...
                {formData.service_type === "air" && (
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={
                        emptyFields.includes("destination_airport")
                          ? "error"
                          : ""
                      }
                    />
                      ...
                      <div className="airport-results">
                        {airportResults.map((airport, index) => (
                          <div
                            key={
                              airport.iata ||
                              `${airport.name}-${airport.city}-${index}`
                            }
                ...
                {formData.service_type === "air" && (
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("cargo_type") ? "error" : ""
                      }
                    >
                ...
                {formData.service_type === "air" && (
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("cargo_description") ? "error" : ""
                      }
                    />
                  </div>
                )}
                {formData.service_type === "air" && (
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={
                        emptyFields.includes("required_delivery_date")
                          ? "error"
                          : ""
                      }
                    />
                ...
                {formData.service_type === "sea" && (
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("shipment_type") ? "error" : ""
                      }
                    >
                  ...
                  formData.shipment_type === "FCL" && (
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className={
                          emptyFields.includes("container_type") ? "error" : ""
                        }
                      >
                ...
                {formData.shipment_type === "FCL" && (
                  <div className="form-group">
                    <label htmlFor="number_of_containers">
                      No. of Containers
                    </label>
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("number_of_containers")
                          ? "error"
                          : ""
                      }
                    >
                ...
                {formData.service_type === "sea" && (
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("port_of_origin") ? "error" : ""
                      }
                    >
                      ...
                      <option value="gqeberha">
                        Port of Gqeberha (Port of Elizabeth)
                      </option>
                ...
                {formData.service_type === "sea" && (
                  <div className="form-group">
                    <label htmlFor="port_of_destination">
                    ...
                    <input
                      ...
                      className={
                        emptyFields.includes("port_of_destination")
                          ? "error"
                          : ""
                      }
                    />
                    ...
                    {seaportResults?.length > 0 && (
                      <div className="sea-port-results">
                        {seaportResults.map((seaport) => (
                          ...
                          >
                            <strong>{seaport.name}</strong>

                            <span>{seaport.country}</span>

                            <span>{seaport.un_locode}</span>
                          </div>
                        ))}
                      </div>
                    )}
                ...
                {formData.service_type === "courier" && (
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("package_name") ? "error" : ""
                      }
                    />
                  </div>
                )}
                ...
                {formData.service_type === "courier" && (
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={
                        emptyFields.includes("package_type") ? "error" : ""
                      }
                    >
              ...
              {formData.service_type === "courier" && (
                <div className="form-group">
                  <label htmlFor="delivery_speed">Service Level</label>
                  <select
                    id="delivery_speed"
                    name="delivery_speed"
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("delivery_speed") ? "error" : ""
                    }
                  >
              ...
              {formData.service_type === "courier" && (
                <div className="form-group">
                  <input
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("street_address") ? "error" : ""
                    }
                  />
                </div>
              )}
              {formData.service_type === "courier" && (
                <div className="form-group">
                  <input
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("postal_code") ? "error" : ""
                    }
                  />
                </div>
              )}
              ...
              {formData.service_type === "courier" && (
                <div className="form-group">
                  <input
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("recipient_street_address")
                        ? "error"
                        : ""
                    }
                  />
              ...
              {formData.service_type === "courier" && (
                <div className="form-group">
                  <input
                    ...
                    onChange={handleChange}
                    className={
                      emptyFields.includes("recipient_city") ? "error" : ""
                    }
                  />
                </div>
              )}
              ...
              <div className="form-group">
                <textarea
                  ...
                  onChange={handleChange}
                  className={
                    emptyFields.includes("additional_information")
                      ? "error"
                      : ""
                  }
                />
          ...
          {loadingSubmit && (
            <div className="loading-overlay">
              <div className="loading-modal">
                ...
                <p>Please wait while we submit your quotation.</p>
              </div>
            </div>
          )}
        </div>
