...
const addOrder = async (req, res) => {
  ...
  console.log("durationSeconds type:", typeof durationSeconds);
  ...
  const orderData = {
    ...
    // address information
    street_address: ["courier", "road"].includes(service_type)
      ? street_address
      : undefined,
    city: ["courier", "road"].includes(service_type) ? city : undefined,
    postal_code: ["courier", "road"].includes(service_type)
      ? postal_code
      : undefined,
    ...
    destination_airport:
      service_type === "air" ? destination_airport : undefined,
    ...
    port_of_destination:
      service_type === "sea" ? port_of_destination : undefined,

    // road
    load_type: service_type === "road" ? load_type : undefined,

    required_delivery_date: ["road", "air", "sea"].includes(service_type)
      ? required_delivery_date
      : undefined,
